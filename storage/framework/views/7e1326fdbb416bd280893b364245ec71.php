...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - Faiaia Store'); ?></title>
</head>
...
<body>
    <div class="row g-0">
        ...
        <div class="col content-grey">
            ...
            <div class="g-0 m-5"> <?php echo $__env->yieldContent('content'); ?>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <small>
                Copyright - <a class="text-reset fw-bold text-decoration-none" target="_blank"
                    href="https://twitter.com/lixlism">
                    Lutfia Cholidina - 3.34.21.0.14
                </a>
            </small>
        </div>
    </div>
    <!-- footer --><?php /**PATH D:\Laravel\my_app\resources\views/layouts/admin.blade.php ENDPATH**/ ?>